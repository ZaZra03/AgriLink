                ...
                <div class="grid grid-cols-5 w-full gap-4">
                    <?php
                        if ($records) {
                            ...
                            echo '
                            <div class="w-full h-[25em] col-span-5 bg-neutral my-4 flex flex-col justify-center gap-3 items-center">
