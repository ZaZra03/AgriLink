<?php
    ...
    $records = $crud->search("product", $_GET['search'], ["name"]);
...
<head>
    ...
    <title>Result for '<?php echo $_GET['search'] ?>'</title>
                                        ...
                                        echo '
                                            <div class="flex flex-col justify-center items-center w-full gap-1 bg-neutral">
                                                <div class="w-full aspect-square bg-gray-300 rounded-t-lg overflow-hidden">
                                                    <img src="/Agrilink-Org/assets/products/'.$records[$i]['image'].'" class="w-full h-full object-cover" />
                                                </div>
                                                ...
                                                <a href="/Agrilink-Org/product.php?id='.$records[$i]['id'].'" class="rounded-t-none btn btn-primary btn-sm col-span-2 w-full">Buy</a>
                                            </div>
                                        ';
                                    }
                                } else {
                                    echo '
                                    <div class="w-full h-[25em] col-span-5 bg-neutral flex flex-col justify-center gap-3 items-center">
