...
<?php
    ...
    echo $productCount;
?>
<body class="relative min-h-full h-full">
    <div class="max-w-[1080px] mx-auto pb-96 pt-[6em]">
        <div class="fixed -ml-[11em] flex flex-col gap-5">
            <div class="card bg-white p-4 w-[10em]">
                <label class="text-lg font-semibold">Categories</label>
                <ul class="ml-3">
                    <li><a href="/agrilink/category.php?q=Crops" class="hover:text-primary">Crops</a></li>
                    <li><a href="/agrilink/category.php?q=Fruits" class="hover:text-primary">Fruits</a></li>
                    <li><a href="/agrilink/category.php?q=Meats" class="hover:text-primary">Meats</a></li>
                    <li><a href="/agrilink/category.php?q=Eggs" class="hover:text-primary">Eggs</a></li>
                    <li><a href="/agrilink/category.php?q=Fishes" class="hover:text-primary">Fishes</a></li>
                    <li><a href="/agrilink/category.php?q=Seafoods" class="hover:text-primary">Seafoods</a></li>
                </ul>
            </div>
            <div class="card bg-white p-4 w-[10em]">
                ...
                <form action="./price_range.php">
                    <div class="flex flex-col gap-5">
                        <div>
                            <label for="min" class="block mb-2 text-sm font-medium text-gray-500 :text-white">Min</label>
                            <input name="min" onchange="document.getElementById('max').min = parseInt(this.value) + 1; document.getElementById('max').value = parseInt(this.value) >= parseInt(document.getElementById('max').value) ? parseInt(this.value) + 1 : document.getElementById('max').value" type="number" value="0" id="min" min="0" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500" required />
                        </div>
                        <div>
                            <label for="max" class="block mb-2 text-sm font-medium text-gray-500 :text-white">Max</label>
                            <input type="number" name="max" id="max" value="1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 :bg-gray-700 :border-gray-600 :placeholder-gray-400 :text-white :focus:ring-blue-500 :focus:border-blue-500" required />
                        </div>
                        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center :bg-blue-600 :hover:bg-blue-700 :focus:ring-blue-800">Filter</button>
                    </div>
                </form>
            </div>
        </div>
        <div class="fixed ml-[68.5em] flex flex-col gap-5">
            <div class="card bg-white p-4 w-[10em]">
                <label class="text-lg font-semibold">Location</label>
                <ul class="ml-3">
                    <li><a href="/agrilink/location.php?q=Calamba" class="hover:text-primary">Calamba</a></li>
                    <li><a href="/agrilink/location.php?q=Cavinti" class="hover:text-primary">Cavinti</a></li>
                    <li><a href="/agrilink/location.php?q=Famy" class="hover:text-primary">Famy</a></li>
                    <li><a href="/agrilink/location.php?q=Kalayaan" class="hover:text-primary">Kalayaan</a></li>
                    <li><a href="/agrilink/location.php?q=Liliw" class="hover:text-primary">Liliw</a></li>
                    <li><a href="/agrilink/location.php?q=Los Baños" class="hover:text-primary">Los Baños</a></li>
                    <li><a href="/agrilink/location.php?q=Lumban" class="hover:text-primary">Lumban</a></li>
                    <li><a href="/agrilink/location.php?q=Mabitac" class="hover:text-primary">Mabitac</a></li>
                    <li><a href="/agrilink/location.php?q=Magdalena" class="hover:text-primary">Magdalena</a></li>
                    <li><a href="/agrilink/location.php?q=Majayjay" class="hover:text-primary">Majayjay</a></li>
                    <li><a href="/agrilink/location.php?q=Nagcarlan" class="hover:text-primary">Nagcarlan</a></li>
                    <li><a href="/agrilink/location.php?q=Paete" class="hover:text-primary">Paete</a></li>
                    <li><a href="/agrilink/location.php?q=Pakil" class="hover:text-primary">Pakil</a></li>
                    <li><a href="/agrilink/location.php?q=Pangil" class="hover:text-primary">Pangil</a></li>
                    <li><a href="/agrilink/location.php?q=Pagsanjan" class="hover:text-primary">Pagsanjan</a></li>
                    <li><a href="/agrilink/location.php?q=Pila" class="hover:text-primary">Pila</a></li>
                    <li><a href="/agrilink/location.php?q=Rizal" class="hover:text-primary">Rizal</a></li>
                    <li><a href="/agrilink/location.php?q=San Pablo" class="hover:text-primary">San Pablo</a></li>
                    <li><a href="/agrilink/location.php?q=Siniloan" class="hover:text-primary">Siniloan</a></li>
                    <li><a href="/agrilink/location.php?q=Sta. Cruz" class="hover:text-primary">Sta. Cruz</a></li>
                </ul>
            </div>
        </div>
                            ...
                            foreach($records as $record) {
                                ...
                                <div class="flex flex-col justify-center items-center w-full gap-1 bg-neutral">
                                    <div class="w-full aspect-square bg-gray-300 rounded-t-lg overflow-hidden">
                                        <img src="/agrilink/assets/products/'.$record['image'].'" class="w-full h-full object-cover" />
                                    </div>
