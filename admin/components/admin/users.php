                    ...
                    if ($records) {
                        ...
                        foreach($records as $record) {
                            if ($record['role'] != "admin") {
                                        ...
                                        '.(
                                            ...
                                            '<td class="px-6 py-4">
                                                <button type="button" data-modal-target="verify-modal'.$record['id'].'" data-modal-toggle="verify-modal'.$record['id'].'" class="p-1 rounded-lg bg-green-400 hover:bg-green-500">
                                                    <svg class="w-5 h-5 text-green-700" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracurrentColorerCarrier" stroke-linecurrentcap="round" stroke-linejoin="round"></g><g id="SVGRepo_icurrentColoronCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="currentColor" stroke-width="2" stroke-linecurrentcap="round" stroke-linejoin="round"></path> </g></svg>
                                                </button>
                                            </td>' : '<td></td>'
                                        ).'
                                    </tr>
                                ...
                                if ($record['id_image']) {
                                    echo '<div id="id-image-modal'.$record['id'].'" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            <div class="relative w-full max-w-lg max-h-full">
                                                ...
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <div class="flex items-center justify-between p-5 border-b rounded-t dark:border-gray-600">
                                                        ...
                                                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-target="id-image-modal'.$record['id'].'" data-modal-toggle="id-image-modal'.$record['id'].'">
                                                    ...
                                                    <form action="/agrilink/modules/add/add_refund.php" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="flex justify-end items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                                                            <button data-modal-target="id-image-modal'.$record['id'].'" data-modal-toggle="id-image-modal'.$record['id'].'" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Close</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
