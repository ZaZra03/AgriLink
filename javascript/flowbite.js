...
var carousel_Default = {
  ...
  indicators: {
    ...
    inactiveClasses: 'bg-white/50 /50 hover:bg-white dark:hover:bg-gray-800'
  },
  interval: 3000,
...
// of the `<html>` and `<body class="relative">` rect bounds if horizontally scrollable
...
var tabs_Default = {
  ...
  inactiveClasses: 'text-gray-500 hover:text-gray-600  border-gray-100 hover:border-gray-300 dark:hover:text-gray-300',
  onShow: function onShow() {}
};
